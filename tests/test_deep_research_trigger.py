...
class TestShouldTriggerDeepResearch:
    ...
    # --- BUY_LIMIT: triggers when R/R > 1.25, conviction irrelevant ---
    ...
    def test_buy_limit_triggers_low_conviction_rr_above_threshold(self):
        """Key new behavior: LOW conviction with R/R > 1.25 should now trigger."""
        svc = _make_service()
    ...
    def test_buy_limit_does_not_trigger_rr_at_threshold(self):
        """R/R must be strictly greater than 1.25."""
        svc = _make_service()
